...
import com.sf.security.SecurityException;
import com.sf.security.SecurityManager;
...
public class XMLSecurityManager implements SecurityManager {
  ...
  public boolean hasAnyObject(String username, String ... objects ) {
    ...
    java.util.Iterator<String> iter = permissions.keySet().iterator();
    while(iter.hasNext()){
    	if(lstObjects.contains(iter.next())){
    		return true;
    	}
    }
    return false;
