...
public class MonthlyJob implements Job {
    ...
    private static Logger _log = LoggerFactory.getLogger(MonthlyJob.class);
    ...
    public void execute(JobExecutionContext context)
        ...
        List<InsuranceDataBean> res = ExpirationUtil.loadMonthlyExpirePolicies();
